...
function showShareModal(invitationId) {
    const baseUrl = window.location.pathname.includes('/admin.html') ? window.location.pathname.replace('/admin.html', '') : window.location.pathname;
